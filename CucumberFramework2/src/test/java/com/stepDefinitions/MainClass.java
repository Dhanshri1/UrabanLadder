...
import com.mindtree.pageobject.BCPage;
import com.mindtree.pageobject.BaseClass;
import com.mindtree.pageobject.BeanBPage;
...
{	
	...
	public void click_on_Bean_Page() throws Exception
	{
		...
		menu.clickOnLiving();
		menu.clickOnBean();
		BeanBPage bag=new BeanBPage(driver);
		Assert.assertTrue(bag.getbeanBTitle().equals("Bean Bags"));
	...
	public void click_on_Bar_Cabinets() throws Exception
	{
		...
		menu.clickOnDinning();
		menu.clickOnCabinet();
		BCPage cabinet=new BCPage(driver);
		Assert.assertTrue(cabinet.getBCT().equals("Bar Cabinets"));
	}
